<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <RestaurantId offline label="RestaurantId" v-model="item.restaurantId" :editMode="false" :key="false" @change="change" />
            <MenuId offline label="MenuId" v-model="item.menuId" :editMode="false" :key="false" @change="change" />
            <DeliveryId offline label="DeliveryId" v-model="item.deliveryId" :editMode="false" :key="false" @change="change" />
        </v-card-text>
